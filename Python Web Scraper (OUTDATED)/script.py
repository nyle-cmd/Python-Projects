...
driver = webdriver.Chrome(executable_path='C:/Users/nyles/Desktop/DS Project/Chrome Driver/chromedriver.exe') #this directory is for the chromedriver extension (outdated)
